...
module HireFire
  # The Worker class is responsible for measuring job queue metrics
  # for various worker libraries and making these metrics available to
  # HireFire's servers. It is initialized with a name and a block of
  ...
  class Worker
    ...
    # Executes the block of work passed during initialization and
    # returns its result. This result should be an integer
    # representing the measured queue metric (latency or size) that
    # will be made available to HireFire's servers.
    #
